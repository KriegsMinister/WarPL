              ...
              if(Object.values(json)[2] !== undefined) {
                  ...
                  embed.addField(user2.PlayerName, ' **Level**: ' + user2.PlayerLevel + 
                      ...
                      if(Object.values(json)[3] !== undefined) {
                        let user3 = Object.values(json)[3];
                        embed.addField(user3.PlayerName, ' **Level**: ' + user3.PlayerLevel + 
                            '\n **Elo / Rank**: ' + Math.round(user3.PlayerElo) + ' | ' + user3.PlayerRank +
                            '\n **Deck**: ' + deck.decode(user3.PlayerDeckContent) + 
                            '\n **Deck Code**: ' + user3.PlayerDeckContent + 
                            '\n **Deck Name**: ' + user3.PlayerDeckName +
                            '\n **Team**: ' + (user3.PlayerAlliance - - 1), true);
                            if(Object.values(json)[4] !== undefined) {
                              let user4 = Object.values(json)[4];
                              embed.addField(user4.PlayerName, ' **Level**: ' + user4.PlayerLevel + 
                                  '\n **Elo / Rank**: ' + Math.round(user4.PlayerElo) + ' | ' + user4.PlayerRank +
                                  '\n **Deck**: ' + deck.decode(user4.PlayerDeckContent) + 
                                  '\n **Deck Code**: ' + user4.PlayerDeckContent + 
                                  '\n **Deck Name**: ' + user4.PlayerDeckName +
                                  '\n **Team**: ' + (user4.PlayerAlliance - - 1), true);
              }
                      }
                    }
              message.channel.send(embed);
